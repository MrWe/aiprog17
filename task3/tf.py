...
def load_data(file):
    ...
    for line in f.readlines():
        ...
        labels.append(TFT.int_to_one_hot(int(line.split(',')[-1].strip()), 9))
...
def gradient_descent(filename, size_features=9, size_labels=7, steps=1000, tvect=None, learning_rate=0.5, showint=10):
